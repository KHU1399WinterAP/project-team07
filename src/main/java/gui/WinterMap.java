 ...
 * @author adel
 */
public class WinterMap extends javax.swing.JFrame {

    /**
     * Creates new form WinterMap
     */
    public WinterMap() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(410, 82));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinterMap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
